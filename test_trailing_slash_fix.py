...
# Also add sunrise-backend-fastapi directory if we're in parent
if 'sunrise-backend-fastapi' not in current_dir:
    backend_dir = os.path.join(current_dir, 'sunrise-backend-fastapi')
...
async def test_trailing_slash_fix():
    ...
    try:
        ...
        test_cases = [
            ...
            {
                "name": "Teachers GET without trailing slash",
                "method": "GET",
                "url": "/api/v1/teachers",
                "expected_status": [200, 401, 422]
            },
            {
                "name": "Teachers GET with trailing slash",
                "method": "GET",
                "url": "/api/v1/teachers/",
                "expected_status": [200, 401, 422]
            },
            {
                "name": "Fees GET without trailing slash",
                "method": "GET",
                "url": "/api/v1/fees",
                "expected_status": [200, 401, 422]
            },
            {
                "name": "Fees GET with trailing slash",
                "method": "GET",
                "url": "/api/v1/fees/",
                "expected_status": [200, 401, 422]
            }
