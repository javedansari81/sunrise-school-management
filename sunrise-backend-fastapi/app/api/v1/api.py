...
from app.api.v1.endpoints import (
    ...
    public, database, transport, dashboard, gallery, reports, inventory, student_siblings
)
...
api_router.include_router(student_siblings.router, prefix="/students", tags=["student-siblings"])
