...
class Settings:
    ...
    # Approved WhatsApp template SID for simple text receipt (school_fee_text_receipt_v6 - 2 variables)
    TWILIO_WHATSAPP_TEXT_RECEIPT_SID: str = os.getenv("TWILIO_WHATSAPP_TEXT_RECEIPT_SID", "")
