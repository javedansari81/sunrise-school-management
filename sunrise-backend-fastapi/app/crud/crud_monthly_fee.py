    ...
    async def get_enhanced_student_summary(
        ...
        for row in rows:
            ...
            summary = EnhancedStudentFeeSummary(
                ...
                roll_number=row.roll_number if hasattr(row, 'roll_number') else None,
                father_name=row.father_name if hasattr(row, 'father_name') else None,
                mobile_number=row.mobile_number if hasattr(row, 'mobile_number') else None,
